...
const styles = [
  ...
  },
  {
    ...
    name: "Retro",
    key: "boxshadow",
    // currentColor = the form's text color, so the effect stays visible on any
    // background (a hardcoded black shadow disappeared on dark forms).
    value: "5px 5px 0px currentColor",
    css: { boxShadow: "5px 5px 0px currentColor" },
  },
  {
    id: 3,
    name: "Border",
  ...
  },
  {
    ...
    name: "Soft Shadow",
    key: "css",
    css: { boxShadow: "0 10px 30px currentColor" },
  },
  {
    id: 5,
    name: "Elevated",
    key: "css",
    css: { boxShadow: "0 20px 45px currentColor" },
  },
  {
    id: 6,
    name: "Dashed",
    key: "css",
    css: { border: "2px dashed currentColor" },
  },
  {
    id: 7,
    name: "Double",
    key: "css",
    css: { border: "4px double currentColor" },
  },
  {
    id: 8,
    name: "Neon",
  ...
  },
  {
    ...
    name: "Inset",
    key: "css",
    css: { boxShadow: "inset 0 2px 12px currentColor" },
  },
  {
    id: 10,
    name: "Left Accent",
    key: "css",
    css: { borderLeft: "6px solid currentColor" },
  },
  {
    id: 11,
    name: "Rounded",
    key: "css",
    css: { border: "3px solid currentColor", borderRadius: "1.5rem" },
  },
  {
    id: 12,
    name: "Glow",
